...
LAUNCHES=(
  "ur5e_bringup gz_moveit.launch.py"
  "ur5e_bringup gz_sim.launch.py"
  "ur5e_bringup pick_moveit.launch.py"
  "ur5e_bringup vision_pick.launch.py"
  "ur5e_bringup moveit_mock.launch.py"
