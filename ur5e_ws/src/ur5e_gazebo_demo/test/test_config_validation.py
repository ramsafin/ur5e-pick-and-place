...
from ur5e_gazebo_demo.config_validation import (
    ARM_JOINTS,
...
def test_ros2_controller_parity(paths):
    ...
    assert demo_arm == sim_arm
    assert demo_gripper == sim_gripper


def test_manipulator_chain(expanded_urdfs):
    from ur5e_gazebo_demo.config_validation import parse_urdf
